...
public class ManageNavigation_EditLandDTO {
	private UUID landID;
	...
	public ManageNavigation_EditLandDTO(UUID landID, String newLandName ,double propertyRentalPrice, int orderCreationDate
	...
	public ManageNavigation_EditLandDTO() {
		super();
	}
	...
	public ManageNavigation_EditLandDTO(UUID landID, String landName,
