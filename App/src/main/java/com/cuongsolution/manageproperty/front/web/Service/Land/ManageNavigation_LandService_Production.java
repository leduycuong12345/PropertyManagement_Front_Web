...
public interface ManageNavigation_LandService_Production {
	public abstract List<ManageNavigation_EditLandDTO> getDetailsLandList_ManageNavigation_Production(String username);
	...
	public abstract void editLand_ManageNavigation_Production(ManageNavigation_EditLandDTO landDTO,String username);
}
